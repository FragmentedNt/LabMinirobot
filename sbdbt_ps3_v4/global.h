...
#define	USE_DUALSHOCK3_RUMBLE		0		//PS3コントローラの振動機能を有効にする('1'受信:右側振動 '2'受信:左側振動)
...
#elif	FORMAT_RCB4
	#define	UARTPARAM1		UARTPARAM_N81	//data=8bit parity=Even stopbit=1bit
	#define BAUDRATE1		115200		//UART1ボーレート
	#define	FORMAT_DATALEN		10		//電文長さ
#elif	FORMAT_RPU
	#define	UARTPARAM1		UARTPARAM_N81	//data=8bit parity=none stopbit=1bit
	#define BAUDRATE1		115200		//UART1ボーレート
...
#define	UART1_MINIMUM_INTERVAL		15		//電文の周期に制限がある場合(SEND_ON_DIFFERENT_DATA=0の場合) 0:なし 1以上:1電文あたりの最低時間(ms)
...
#define	OUT_DIGITAL_RECTANGLE           0x0080
#define	OUT_DIGITAL_L1			0x0100
#define	OUT_DIGITAL_L2			0x0200
#define	OUT_DIGITAL_L3			0x0400

#define	OUT_DIGITAL_R1			0x0800
#define	OUT_DIGITAL_R2			0x1000
#define	OUT_DIGITAL_R3			0x2000

#define	OUT_DIGITAL_START		0x4000
#define	OUT_DIGITAL_SELECT		0x8000
#define	OUT_DIGITAL_PS			0x0000
#endif
...
extern unsigned int sixaxis_button_state;
extern BYTE sixaxis_home;
